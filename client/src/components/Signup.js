...
const Signup = () =>{
    ...
    const [user,SetUser] = useState({
        name:"",username:"",email:"",phone:"",work:"",interest:"",password:"",cpassword:""
    });
    ...
    const PostData = async (e) => {
        ...
        const {name,username,email,phone,work,interest,password,cpassword} = user;
                ...
                <div className='signup-form'>
                    ...
                    <form  method="POST" className='register-form' id='register-form'>
                        ...
                        <div className='Form-element'>
                            ...
                            <select type="text" name="interest" id='interest' value={user.interest}
                            onChange={handleInputs}>
