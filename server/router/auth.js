...
router.post('/register', async (req,res)=> {
    ...
    const {name,username,email,phone,work,interest,password,cpassword} = req.body;
    ...
    try{
     ...
     if(userExist){
        ...
        const user = new User({name,username,email,phone,work,interest,password,cpassword});
        await user.save();
...
router.post('/SendRequest', async (req,res)=> {
    ...
    const {sender,username,currentdate,date,location,restaurant,status,condition} = req.body;
    ...
    try{
       ...
       const meeting = new Meeting({sender,username,currentdate,date,location,restaurant,status,condition});
        await meeting.save();
...
router.get('/SendRequest',(req,res)=>{
    User.find({},{username:1, name: 1, work:1, interest:1, email:1, phone: 1, _id:0}).then((result)=>{
        res.send(result);
    }).catch((err)=>{
        console.log(err);
    });
...
router.get('/MeetingStatus',(req,res)=>{
    Meeting.find({},{sender:1, username: 1, currentdate:1, date:1, location:1, restaurant: 1,status:1, _id:1}).then((result)=>{
        res.send(result);
    }).catch((err)=>{
        console.log(err);
    });
