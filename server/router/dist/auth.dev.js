...
router.post('/register', function _callee(req, res) {
  var _req$body, name, username, email, phone, work, interest, password, cpassword, userExist, usernameExist, user;

  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, name = _req$body.name, username = _req$body.username, email = _req$body.email, phone = _req$body.phone, work = _req$body.work, interest = _req$body.interest, password = _req$body.password, cpassword = _req$body.cpassword;

          if (!(!name || !username || !email || !phone || !work || !password || !cpassword || !interest)) {
            _context.next = 3;
            break;
          }
...
router.post('/SendRequest', function _callee2(req, res) {
  var _req$body2, sender, username, currentdate, date, location, restaurant, status, condition, meeting;

  return regeneratorRuntime.async(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _req$body2 = req.body, sender = _req$body2.sender, username = _req$body2.username, currentdate = _req$body2.currentdate, date = _req$body2.date, location = _req$body2.location, restaurant = _req$body2.restaurant, status = _req$body2.status, condition = _req$body2.condition;

          if (!(!sender || !username || !date || !location || !restaurant || !status || !condition || !currentdate)) {
            _context2.next = 3;
            break;
          }
...
router.post('/ReceiveRequest', function _callee9(req, res) {
  var _req$body5, id, status, condition, today, currentdate, result;
    ...
    while (1) {
      switch (_context9.prev = _context9.next) {
        case 0:
          ...
          today = new Date();
          currentdate = today.toLocaleString("en-US", "Asia/Delhi");
